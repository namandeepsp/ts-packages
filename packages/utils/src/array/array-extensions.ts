...
export function extendArray() {
	...
	defineExtension(Array.prototype, 'chunk', function <
		T,
	>(this: readonly T[], size: number): T[][] {
	...
	defineExtension(Array.prototype, 'groupBy', function <
		T,
	>(this: readonly T[], keyFn: (item: T) => string | number): Record<
		string | number,
		T[]
	> {
	...
	defineExtension(Array.prototype, 'pluck', function <
		T extends Record<PropertyKey, any>,
		K extends keyof T,
	>(this: readonly T[], key: K): T[K][] {
		return this.map((item) => item[key]).filter(
			(val): val is T[K] => val !== undefined,
		)
	})

	defineExtension(Array.prototype, 'findLast', function <
		T,
	>(this: readonly T[], predicate: (item: T) => boolean): T | undefined {
	...
	defineExtension(Array.prototype, 'partition', function <
		T,
	>(this: readonly T[], predicate: (item: T) => boolean): [T[], T[]] {
		if (typeof predicate !== 'function') {
			throw new TypeError(
	...
	defineExtension(Array.prototype, 'difference', function <
		T,
	>(this: readonly T[], other: T[]): T[] {
	...
	defineExtension(Array.prototype, 'intersection', function <
		T,
	>(this: readonly T[], other: T[]): T[] {
		if (!Array.isArray(other)) {
			throw new TypeError(
	...
	defineExtension(Array.prototype, 'union', function <
		T,
	>(this: readonly T[], other: T[]): T[] {
		if (!Array.isArray(other)) {
	...
	defineExtension(Array.prototype, 'sample', function <T>(this: readonly T[]):
		| T
		| undefined {
	...
	defineExtension(Array.prototype, 'take', function <
		T,
	>(this: readonly T[], count: number): T[] {
		return this.slice(0, Math.max(0, count))
	})

	defineExtension(Array.prototype, 'drop', function <
		T,
	>(this: readonly T[], count: number): T[] {
		return this.slice(Math.max(0, count))
	})

	defineExtension(Array.prototype, 'uniqueBy', function <
		T,
		K,
	>(this: readonly T[], keyFn: (item: T) => K): T[] {
		if (typeof keyFn !== 'function') {
			throw new TypeError(
				`uniqueBy: keyFn must be a function, got ${typeof keyFn}`,
			)
		}
	...
	defineExtension(Array.prototype, 'sortBy', function <
		T,
	>(this: readonly T[], keyFn: (item: T) => any): T[] {
		if (typeof keyFn !== 'function') {
			throw new TypeError(
				`sortBy: keyFn must be a function, got ${typeof keyFn}`,
			)
		}
	...
	defineExtension(Array.prototype, 'last', function <T>(this: readonly T[]):
		| T
		| undefined {
