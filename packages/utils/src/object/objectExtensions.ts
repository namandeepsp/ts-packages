...
export function extendObject() {
	...
	defineExtension(
		Object.prototype,
		'isEmpty',
		function (this: object): boolean {
			return Object.keys(this).length === 0
		},
	)

	defineExtension(Object.prototype, 'pick', function <
		T extends Record<string, any>,
		K extends keyof T,
	>(this: T, keys: K[]): Pick<T, K> {
	...
	defineExtension(Object.prototype, 'omit', function <
		T extends Record<string, any>,
		K extends keyof T,
	>(this: T, keys: K[]): Omit<T, K> {
	...
	defineExtension(Object.prototype, 'merge', function <
		T extends object,
	>(this: T, other: Partial<T>): T {
		return { ...this, ...other }
	})
	...
	defineExtension(
		Object.prototype,
		'hasPath',
		function (this: object, path: string): boolean {
	...
	defineExtension(
		Object.prototype,
		'getPath',
		function (this: object, path: string, defaultValue?: any): any {
			if (!path.trim()) throw new TypeError('getPath: path cannot be empty')
			return path
				.split('.')
				.reduce(
					(acc: any, key) => (acc && key in acc ? acc[key] : defaultValue),
					this as any,
				)
		},
	)
	...
	defineExtension(
		Object.prototype,
		'setPath',
		function (this: object, path: string, value: any): any {
	...
	defineExtension(Object.prototype, 'mapValues', function <
		T extends Record<string, any>,
	>(this: T, fn: (value: T[keyof T], key: keyof T) => any): Record<
		string,
		any
	> {
	...
	defineExtension(Object.prototype, 'mapKeys', function <
		T extends Record<string, any>,
	>(this: T, fn: (key: keyof T) => string | number | symbol): Record<
		string,
		any
	> {
		if (typeof fn !== 'function') {
	...
	defineExtension(Object.prototype, 'filterKeys', function <
		T extends Record<string, any>,
	>(this: T, keys: (keyof T)[]): Partial<T> {
		if (!Array.isArray(keys)) {
			throw new TypeError(
				`filterKeys: keys must be an array, got ${typeof keys}`,
			)
		}
	...
	defineExtension(Object.prototype, 'filterValues', function <
		T extends Record<string, any>,
	>(this: T, fn: (value: T[keyof T], key: keyof T) => boolean): Partial<T> {
		if (typeof fn !== 'function') {
			throw new TypeError(
				`filterValues: fn must be a function, got ${typeof fn}`,
			)
		}
		const result: Partial<T> = {}
		for (const key in this) {
