...
export function validateConfig(config: Partial<PerformanceConfig>, defaultConfig: PerformanceConfig): PerformanceConfig {
    return { ...defaultConfig, ...config };
}

export function validatePerformanceSettings(settings: Partial<PerformanceConfig>): PerformanceConfig {
