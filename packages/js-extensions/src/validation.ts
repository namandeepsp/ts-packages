...
export function validateExtensionInput(value: any, type: string, methodName: string): void {
  if (value == null) {
...
export function validateNumberRange(num: number, min: number, max: number, methodName: string): void {
  if (num < min || num > max) {
